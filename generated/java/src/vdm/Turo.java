...
public class Turo {
  ...
  public static Date CurrentDate = new Date(8, 1, 2019);
  ...
  public static void addTransaction(final Transaction transaction) {
    ...
    System.out.println("You were just charged " + transaction.getAmount() + "€");
  ...
  public User getUser(final String email) {
    ...
    for (Iterator iterator_11 = carOwners.iterator(); iterator_11.hasNext(); ) {
      User o = (User) iterator_11.next();
      if (Utils.equals(email, o.getEmail())) {
        user = o;
      }
